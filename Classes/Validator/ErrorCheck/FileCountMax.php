...
use Typoheads\Formhandler\Domain\Model\Config\Validator\ErrorCheck\FileCountMaxModel;

class FileCountMax extends AbstractErrorCheck {
  public function isValid(FormModel &$formConfig, AbstractErrorCheckModel &$errorCheckConfig, string $fieldNamePathBrackets, string $fieldNamePathDots, mixed $value): bool {
    if (!$errorCheckConfig instanceof FileCountMaxModel) {
      return false;
    }

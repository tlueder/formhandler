...
use Typoheads\Formhandler\Domain\Model\Config\Validator\ErrorCheck\FileCountMinModel;

class FileCountMin extends AbstractErrorCheck {
  public function isValid(FormModel &$formConfig, AbstractErrorCheckModel &$errorCheckConfig, string $fieldNamePathBrackets, string $fieldNamePathDots, mixed $value): bool {
    if (!$errorCheckConfig instanceof FileCountMinModel) {
      return false;
    }
